...
namespace InterviewAssistant.Core.Models
{
    ...
    public class KeyboardShortcut
    {
        ...
        public ShortcutAction Action { get; set; } = ShortcutAction.CaptureAndProcess;
        ...
        public KeyboardShortcut(string combination, string description, string promptId)
        {
        ...
        public KeyboardShortcut(string combination, string description, ShortcutAction action)
        {
            Combination = combination;
            Description = description;
            Action = action;
        ...
        /// <summary>
        /// Parse the combination into modifier keys and main key
        /// </summary>
        public (ModifierKeys modifiers, VirtualKeyCode key) ParseCombination()
        {
        ...
        /// </summary>
        public bool Matches(ModifierKeys modifiers, VirtualKeyCode key)
        {
            var (expectedModifiers, expectedKey) = ParseCombination();
    ...
    public class KeyboardShortcutEvent
    {
        ...
        public KeyboardShortcut? ShortcutDefinition { get; set; }
    ...
    public static class KeyParser
    {
        public static VirtualKeyCode Parse(string key)
        {
            ...
            if (Enum.TryParse<VirtualKeyCode>(upperKey, true, out var result))
            {
                return result;
            }
            ...
            return upperKey switch
            {
                ...
                "PGUP" or "PAGEUP" => VirtualKeyCode.Prior,
                "PGDN" or "PAGEDOWN" => VirtualKeyCode.Next,
                "DEL" or "DELETE" => VirtualKeyCode.Delete,
                "INS" or "INSERT" => VirtualKeyCode.Insert,
                "SPACEBAR" or "SPACE" => VirtualKeyCode.Space,
                "TAB" => VirtualKeyCode.Tab,
                "BACKSPACE" or "BACK" => VirtualKeyCode.Back,
                "PRTSC" or "PRINTSCREEN" => VirtualKeyCode.Snapshot,
